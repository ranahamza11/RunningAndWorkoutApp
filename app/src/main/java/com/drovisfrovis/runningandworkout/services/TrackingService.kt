package com.drovisfrovis.runningandworkout.services
...
import com.drovisfrovis.runningandworkout.misc.Constants.FASTEST_LOCATION_INTERVAL
import com.drovisfrovis.runningandworkout.misc.Constants.LOCATION_UPDATE_INTERVAL
import com.drovisfrovis.runningandworkout.misc.Constants.NOTIFICATION_CHANNEL_ID
import com.drovisfrovis.runningandworkout.misc.Constants.NOTIFICATION_CHANNEL_NAME
import com.drovisfrovis.runningandworkout.misc.Constants.NOTIFICATION_ID
import com.drovisfrovis.runningandworkout.misc.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun startTimer(){
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while (isTracking.value!!) {
                ...
                timeRunInMillis.postValue(lapTime + totalTimeRun)
    ...
    private fun startForegroundService(){
        ...
        timeRunInSeconds.observe(this, Observer {
            if(!isServiceKilled) {
                val notification = currNotificationBuilder.setContentText(TrackingUtility.getFormattedStopwatchTime(it * 1000L))
