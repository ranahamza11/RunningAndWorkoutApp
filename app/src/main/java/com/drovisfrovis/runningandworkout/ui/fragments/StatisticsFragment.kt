...
import com.drovisfrovis.runningandworkout.misc.CustomMarkerView
import com.drovisfrovis.runningandworkout.misc.TrackingUtility
import com.drovisfrovis.runningandworkout.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment: Fragment(R.layout.fragment_statistics) {
    ...
    fun makeChangesToObserver() {
        ...
        viewModel.totalAvgSpeed.observe(viewLifecycleOwner, Observer {
            it?.let {
                val totalAvgSpeed = "${round(it * 10f) /10f}km/h"
